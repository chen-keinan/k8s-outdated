...
func TestMapResources(t *testing.T) {
	tests := []struct {
		...
		{name: "line #4 ", K8sObject: []collector.K8sObject{{Removed: "v1.25", Gav: collector.Gav{Version: "v2beta1", Group: "autoscaling", Kind: "HorizontalPodAutoscaler"}}}, markDownLine: "### v1.25\n\n#### HorizontalPodAutoscaler {#horizontalpodautoscaler-v125}\n\nThe **autoscaling/v2beta1** API version of HorizontalPodAutoscaler will no longer be served in v1.25."},
		{name: "line #5 ", K8sObject: []collector.K8sObject{{Removed: "v1.22", Gav: collector.Gav{Version: "v1beta1", Group: "admissionregistration.k8s.io", Kind: "MutatingWebhookConfiguration"}},
			{Removed: "v1.22", Gav: collector.Gav{Version: "v1beta1", Group: "admissionregistration.k8s.io", Kind: "ValidatingWebhookConfiguration"}}}, markDownLine: "### v1.22\n\nThe **v1.22** release stopped serving theUpper following deprecated API versions:\n\n#### Webhook resources {#webhook-resources-v122}\n\nThe **admissionregistration.k8s.io/v1beta1** API version of MutatingWebhookConfiguration and ValidatingWebhookConfiguration is no longer served as of v1.22."},
		{name: "line #6 ", K8sObject: []collector.K8sObject{{Removed: "v1.25", Gav: collector.Gav{Version: "v2beta1", Group: "node.k8s.io", Kind: "RuntimeClass"}}}, markDownLine: "\t\t{name: \"line #4 \", K8sObject: []collector.K8sObject{{Removed: \"v1.25\", Gav: collector.Gav{Version: \"v2beta1\", Group: \"autoscaling\", Kind: \"HorizontalPodAutoscaler\"}}}, markDownLine: \"### v1.25\\n\\n#### HorizontalPodAutoscaler {#horizontalpodautoscaler-v125}\\n\\nThe **autoscaling/v2beta1** API version of HorizontalPodAutoscaler will no longer be served in v1.25.\"},\n"},
	}
